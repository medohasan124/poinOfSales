    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
              <h3 class="card-title">@lang('client')</h3>
              ...
              @endif
              <a href='{{url('client/create')}}'><button class='btn btn-success'>@lang('add_client') <i class='fa fa-user'></i></button></a>
            ...
            <div class="card-body">
                <table id="myTable" class="display text-center">
                    ...
                    <tbody>
                        ...
                        @endforeach
                         {{-- modal delete client --}}
                        @include('client::modal.deleteModal')
...
$('.show-modal-delete').click(function(){
    ...
    var url = "{{ route('client.destroy', ':catId') }}";
